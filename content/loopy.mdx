...
unlisted: false
order: 1
summary: "Loopy turns a product brief into three distinct prototypes, helps me choose and critique a direction, then carries what I learn from testing into the next round."
---
...
That is what I had been building for myself. A senior designer agent opens up possibilities and makes things. A principal designer agent questions the work before it moves forward. Other roles handle research, evaluation, implementation, or verification. They are not magic employees. They are parts of a process I have shaped over time.
...
## One agent makes. Another pushes back.

Once I choose a direction, the senior designer builds it. The principal designer reviews it.

The roles need different incentives. The senior designer is supposed to find a way forward. The principal designer is supposed to question whether the work deserves to move forward. If both agents are optimized to be agreeable, the loop becomes theater.
...
The current beta handles structured briefs, project context, three independently generated directions, concept selection, the designer and critic handoff, scorecards, approve/steer/reject routing, test publishing, feedback collection, outcome evaluation, and a human-approved next brief.
...
Loopy is live. [Visit loopy.design and take it for a lap →](https://loopy.design)
