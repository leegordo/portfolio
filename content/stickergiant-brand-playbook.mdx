...
order: 2
comingSoon: false
summary: "Built a machine-readable brand system where the rules are the product — consumed by humans, AI agents, and automated workflows from the same JSON source of truth."
