...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Lee Gordon. Product design, UX research, and design leadership.",
};
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white group-hover:text-amber-400 transition-colors duration-300 font-medium">
                      {contact.email}
                    </p>
                  </div>
                </a>
