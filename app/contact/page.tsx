          ...
          <div>
            ...
            <ScrollReveal delay={0.3}>
              <div className="space-y-6">
                {/* Email */}
                <div className="group flex items-start gap-4 p-5 rounded-xl bg-surface-50 border border-white/5 hover:border-white/20 transition-all duration-300">
                  <div className="w-10 h-10 rounded-lg bg-white/10 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-white/10 transition-colors duration-300">
                    <svg className="w-5 h-5 text-neutral-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                {contact.linkedinUrl && (
                  <a
                    ...
                    className="group flex items-start gap-4 p-5 rounded-xl bg-surface-50 border border-white/5 hover:border-white/20 transition-all duration-300"
                  >
                    <div className="w-10 h-10 rounded-lg bg-white/10 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-white/10 transition-colors duration-300">
                      <svg className="w-5 h-5 text-neutral-200" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-white group-hover:text-white transition-colors duration-300 font-medium flex items-center gap-2">
                ...
                <div className="w-64 h-64 rounded-full border border-white/5 flex items-center justify-center">
                  <div className="w-48 h-48 rounded-full border border-white/5 flex items-center justify-center">
                    <div className="w-32 h-32 rounded-full border border-white/10 flex items-center justify-center">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-neutral-200 to-neutral-400 flex items-center justify-center">
