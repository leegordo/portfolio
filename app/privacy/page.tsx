...
const sections = [
  ...
  },
  {
    ...
    body: `GitHub Pages hosts and delivers the site. Google Fonts supplies webfont files and stylesheets. The site does not include advertising networks, social media trackers, or analytics services.`,
  },
  {
