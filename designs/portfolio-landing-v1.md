...
|---------|----------|-----------|
| **Background** | `#0c0c10` deep void | Carries over the 0xCreative dark aesthetic. Noisy dark is more interesting than pure black. |
| **Accent** | `#e85a8a` pink | Pops against the void without being garish. Used sparingly: label, CTA, arrows. |
